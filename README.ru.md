...
* **`env`** - Показывает переменные вашей ОС.
...
* **`zip <file.*`** - Заархивировать файл, указав расширение, файл архивируется в корневую папку программы.
* **`unzip <file.zip`** - Разархивировать файл, указав расширение формата .zip, файл распакуется в корневую папку программы.
...
###  NET
* **`ip`** - Показать айпи устройства.
* **`download <download link>`** - Скачать по ссылке в корневую папку терминала.
* **`ping <website>`** - Проверить пинг сайта.
